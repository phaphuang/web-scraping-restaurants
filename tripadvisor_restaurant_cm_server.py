...
def dl_page_src(url):
    ...
    try:
        ...
        with open('tripadvisor_chiangmai_restaurant.html', 'w') as saved_page:
            saved_page.write(soup.prettify(encoding='utf-8'))
    except:
        print('Error')
...
def dl_review_page_src(url):
    ...
    try:
        response = requests.get(url, headers=headers)
        soup = BeautifulSoup(response.content, 'html.parser')
        with open('tripadvisor_chiangmai_restaurant_review.html', 'w') as saved_page:
            saved_page.write(soup.prettify(encoding='utf-8'))
    except:
        print('Error')
...
def main():
    ...
    with open('tripadvisor_chiangmai_restaurant.html') as page_src:
    ...
    for page_no in range(page_count):
        ...
        for result in page_results:
            ...
            with open('tripadvisor_chiangmai_restaurant_review.html') as page_src:
